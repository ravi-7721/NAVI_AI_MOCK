...
export const dummyInterviews: Interview[] = [
  ...
  },
  {
    ...
    type: "Mixed",
    techstack: ["HTML", "CSS", "JavaScript", "Java", "Spring Boot", "SQL", "MySQL", "NoSQL"],
    level: "Mid",
...
export const interviewTemplates = [
  ...
  },
  {
    ...
    techstack: ["HTML", "CSS", "JavaScript", "Java", "Spring Boot", "SQL", "MySQL", "NoSQL"],
    questions: [
      "How do HTML, CSS, and JavaScript fit into a full stack Java application?",
      "How does dependency injection work in Spring Boot?",
      "How would you secure REST APIs in a Java backend?",
      "How do you structure communication between a JavaScript frontend and Spring services?",
      "How do you model data across SQL and NoSQL databases in the same system?",
